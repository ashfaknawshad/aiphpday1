...
<body>
    ...
    <div class="jumbotron text-center">
        <h1 class="display-4">Welcome to TechWave Solutions</h1>
        <p class="lead">TechWave Solutions is a cutting-edge technology company specializing in providing innovative software solutions to businesses worldwide. Our mission is to empower organizations with the latest technology to streamline their operations and enhance their productivity.</p>
        <hr class="my-4">
        <h3 class="display-7 mb-4">Ready for your dream job? We are hiring!</h3>
        <a class="btn btn-primary btn-lg" href="register.php" role="button">Register Now!</a>
    </div>

    <div class="container mb-5">
        <h3 class="display-4 text-center mb-4">Our Services</h3>
        <div class="row">
            <div class="col-md-4">
                <div class="card">
